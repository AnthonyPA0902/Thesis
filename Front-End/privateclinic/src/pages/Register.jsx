                    ...
                    <div className="row align-items-center justify-content-center">
                        <div className="col-md-7">
                            ...
                            <form action="form.php" method="post">
                                <div className="form-group last mb-3" style={{ border: '1px solid gray', padding: '5px' }}>
                                    <input type="text" className="form-control" id="name" placeholder="Họ Tên" style={{ fontSize: '13px' }} />
                                </div>
                                <div className="form-group last mb-3" style={{ border: '1px solid gray', padding: '5px' }}>
                                    <input type="number" className="form-control" id="age" placeholder="Tuổi" style={{ fontSize: '13px' }} />
                                </div>
                                <div className="form-group last mb-3" style={{ border: '1px solid gray', padding: '5px' }}>
                                    <input type="text" className="form-control" id="address" placeholder="Địa Chỉ" style={{ fontSize: '13px' }} />
                                </div>
                                <div className="form-group last mb-3" style={{ border: '1px solid gray', padding: '5px' }}>
                                    <input type="text" className="form-control" id="email" placeholder="Email" style={{ fontSize: '13px' }} />
                                </div>
                                <div className="form-group last mb-3" style={{ border: '1px solid gray', padding: '5px' }}>
                                    <input type="text" className="form-control" id="phone" placeholder="Số Điện Thoại" style={{ fontSize: '13px' }} />
                                </div>
                                <div className="form-group first" style={{ marginBottom: '20px', border: '1px solid gray', padding: '5px' }}>
